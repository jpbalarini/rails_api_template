  ...
  describe "POST 'facebook_login'" do
    ...
    context 'with valid params' do
      context 'when the user does not exists' do
        it "should create a new facebook user" do
          expect {
            post :facebook_login, user: @params , format: 'json'
      ...
      context 'when the user exists' do
        it 'should not create a new user record' do
          ...
          expect {
            post :facebook_login, user: @new_user, format: :json
    ...
    context 'with invalid params' do
      it "should not create an user on empty data" do
        expect {
          post :facebook_login, user: {} , format: 'json'
        }.not_to change { User.count }
      end

      it "should not create an user on bad data" do
        expect {
          post :facebook_login, user: { facebook_id: '', first_name: 'some' } , format: 'json'
        }.not_to change { User.count }
      end
    end
  end
