...
module SimpleTokenAuthentication
  Entity.class_eval do
    def auth_provider(headers)
      header_name = SimpleTokenAuthentication.header_names["#{name_underscore}".to_sym][:facebook_id]
      use_fb = header_name.present? && headers[header_name].present?
      use_fb ? :facebook_id : :email
    end
